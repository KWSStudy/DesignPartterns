...
public class positionStation {
	...
	public static void main(String[] args) {
		...
		CurrentDisplay currentDisplay1 = new CurrentDisplay(positionData);
		CurrentDisplay currentDisplay2 = new CurrentDisplay(positionData);
		positionData.setPosition(12.5f, 25.6f);
